...
public partial class Booking : System.Web.UI.Page
{
    ...
    public void sendeMailConformation(string toemail)
    {
        ...
        {
            NetworkCredential login = new NetworkCredential("hotelmanagementgroup5@gmail.com", "hotelforyou");
        ...
        client.UseDefaultCredentials = false;
        client.Credentials = new System.Net.NetworkCredential("hotelmanagementgroup5@gmail.com", "hotelforyou");
        client.Port = 587;
        client.Send(email);
        */
